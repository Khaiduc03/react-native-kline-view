...
class HTKdjDraw: NSObject, HTKLineDrawProtocol {
    ...
    func drawLine(_ model: HTKLineModel, _ lastModel: HTKLineModel, _ maxValue: CGFloat, _ minValue: CGFloat, _ baseY: CGFloat, _ height: CGFloat, _ index: Int, _ lastIndex: Int, _ context: CGContext, _ configManager: HTKLineConfigManager) {
        let itemList = [
            ["value": model.kdjK, "lastValue": lastModel.kdjK, "color": safeTargetColor(configManager, at: 0, fallback: configManager.textColor)],
            ["value": model.kdjD, "lastValue": lastModel.kdjD, "color": safeTargetColor(configManager, at: 1, fallback: configManager.textColor)],
            ["value": model.kdjJ, "lastValue": lastModel.kdjJ, "color": safeTargetColor(configManager, at: 2, fallback: configManager.textColor)],
        ]
    ...
    func drawText(_ model: HTKLineModel, _ baseX: CGFloat, _ baseY: CGFloat, _ context: CGContext, _ configManager: HTKLineConfigManager) {
        ...
        let itemList = [
            ...
            ["title": String(format: "K:%@", configManager.precision(model.kdjK, -1)), "color": safeTargetColor(configManager, at: 0, fallback: configManager.textColor)],
            ["title": String(format: "D:%@", configManager.precision(model.kdjD, -1)), "color": safeTargetColor(configManager, at: 1, fallback: configManager.textColor)],
            ["title": String(format: "J:%@", configManager.precision(model.kdjJ, -1)), "color": safeTargetColor(configManager, at: 2, fallback: configManager.textColor)],
        ]
