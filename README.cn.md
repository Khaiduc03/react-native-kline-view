# React Native K 线图表库 / K-line Chart Library

<div align="center">
  <img src="./example/logo.png" alt="React Native KLine View" width="120" height="120" style="border-radius: 60px;" />
</div>

**专业的 React Native K 线（蜡烛图）图表库** / **Professional React Native K-line (Candlestick) Chart Library**

_超流畅渲染 • 交互式绘图工具 • 多种技术指标 • 深色/浅色主题_ / _Ultra-smooth rendering • Interactive drawing tools • Multiple technical indicators • Dark/Light themes_
